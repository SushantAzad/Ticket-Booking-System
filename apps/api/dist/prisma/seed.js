...
async function main() {
    ...
    const cinemaStandard = await prisma.seatCategory.upsert({
        where: { venueId_name: { venueId: cinemaVenue.id, name: client_1.SeatCategoryName.STANDARD } },
        update: {},
        create: { venueId: cinemaVenue.id, name: client_1.SeatCategoryName.STANDARD, colorCode: '#4ade80' },
    });
    const cinemaPremium = await prisma.seatCategory.upsert({
        where: { venueId_name: { venueId: cinemaVenue.id, name: client_1.SeatCategoryName.PREMIUM } },
        update: {},
        create: { venueId: cinemaVenue.id, name: client_1.SeatCategoryName.PREMIUM, colorCode: '#facc15' },
    });
    const cinemaVip = await prisma.seatCategory.upsert({
        where: { venueId_name: { venueId: cinemaVenue.id, name: client_1.SeatCategoryName.VIP } },
        update: {},
        create: { venueId: cinemaVenue.id, name: client_1.SeatCategoryName.VIP, colorCode: '#a78bfa' },
    });
    ...
    for (const row of cinemaRows) {
        ...
        const categoryId = rowIndex <= 1 ? cinemaVip.id : rowIndex <= 4 ? cinemaPremium.id : cinemaStandard.id;
    ...
    const concertStandard = await prisma.seatCategory.upsert({
        where: { venueId_name: { venueId: concertVenue.id, name: client_1.SeatCategoryName.STANDARD } },
        update: {},
        create: { venueId: concertVenue.id, name: client_1.SeatCategoryName.STANDARD, colorCode: '#4ade80' },
    });
    const concertPremium = await prisma.seatCategory.upsert({
        where: { venueId_name: { venueId: concertVenue.id, name: client_1.SeatCategoryName.PREMIUM } },
        update: {},
        create: { venueId: concertVenue.id, name: client_1.SeatCategoryName.PREMIUM, colorCode: '#facc15' },
    });
    const concertVip = await prisma.seatCategory.upsert({
        where: { venueId_name: { venueId: concertVenue.id, name: client_1.SeatCategoryName.VIP } },
        update: {},
        create: { venueId: concertVenue.id, name: client_1.SeatCategoryName.VIP, colorCode: '#a78bfa' },
    });
    ...
    for (const row of concertRows) {
        ...
        const categoryId = sectionPrefix === 'pit' ? concertVip.id : sectionPrefix === 'mid' ? concertPremium.id : concertStandard.id;
    ...
    const concertEvent = await prisma.event.upsert({
        ...
        create: {
            ...
            type: client_1.EventType.CONCERT,
            genre: 'Rock',
            posterUrl: null,
            organiserId: organiser.id,
        },
    ...
    const liveEvent = await prisma.event.upsert({
        ...
        create: {
            ...
            type: client_1.EventType.LIVE_EVENT,
            genre: 'Comedy',
            posterUrl: null,
            organiserId: organiser.id,
        },
    ...
    await prisma.showSeatCategoryPrice.upsert({
        ...
        update: {},
        create: { showId: movieShow1.id, categoryId: cinemaStandard.id, price: new library_1.Decimal('200') },
    });
    await prisma.showSeatCategoryPrice.upsert({
        where: { showId_categoryId: { showId: movieShow1.id, categoryId: cinemaPremium.id } },
        update: {},
        create: { showId: movieShow1.id, categoryId: cinemaPremium.id, price: new library_1.Decimal('350') },
    });
    await prisma.showSeatCategoryPrice.upsert({
        where: { showId_categoryId: { showId: movieShow1.id, categoryId: cinemaVip.id } },
        update: {},
        create: { showId: movieShow1.id, categoryId: cinemaVip.id, price: new library_1.Decimal('600') },
    });
    await prisma.showSeatCategoryPrice.upsert({
        where: { showId_categoryId: { showId: movieShow2.id, categoryId: cinemaStandard.id } },
        update: {},
        create: { showId: movieShow2.id, categoryId: cinemaStandard.id, price: new library_1.Decimal('300') },
    });
    await prisma.showSeatCategoryPrice.upsert({
        where: { showId_categoryId: { showId: movieShow2.id, categoryId: cinemaPremium.id } },
        update: {},
        create: { showId: movieShow2.id, categoryId: cinemaPremium.id, price: new library_1.Decimal('500') },
    });
    await prisma.showSeatCategoryPrice.upsert({
        where: { showId_categoryId: { showId: movieShow2.id, categoryId: cinemaVip.id } },
        update: {},
        create: { showId: movieShow2.id, categoryId: cinemaVip.id, price: new library_1.Decimal('900') },
    });
    await prisma.showSeatCategoryPrice.upsert({
        where: { showId_categoryId: { showId: concertShow.id, categoryId: concertStandard.id } },
        update: {},
        create: { showId: concertShow.id, categoryId: concertStandard.id, price: new library_1.Decimal('800') },
    });
    await prisma.showSeatCategoryPrice.upsert({
        where: { showId_categoryId: { showId: concertShow.id, categoryId: concertPremium.id } },
        update: {},
        create: { showId: concertShow.id, categoryId: concertPremium.id, price: new library_1.Decimal('1500') },
    });
    await prisma.showSeatCategoryPrice.upsert({
        where: { showId_categoryId: { showId: concertShow.id, categoryId: concertVip.id } },
        update: {},
        create: { showId: concertShow.id, categoryId: concertVip.id, price: new library_1.Decimal('3000') },
    });
    await prisma.showSeatCategoryPrice.upsert({
        where: { showId_categoryId: { showId: liveShow.id, categoryId: cinemaStandard.id } },
        update: {},
        create: { showId: liveShow.id, categoryId: cinemaStandard.id, price: new library_1.Decimal('400') },
    });
    await prisma.showSeatCategoryPrice.upsert({
        where: { showId_categoryId: { showId: liveShow.id, categoryId: cinemaPremium.id } },
        update: {},
        create: { showId: liveShow.id, categoryId: cinemaPremium.id, price: new library_1.Decimal('700') },
    });
    await prisma.showSeatCategoryPrice.upsert({
        where: { showId_categoryId: { showId: liveShow.id, categoryId: cinemaVip.id } },
        update: {},
        create: { showId: liveShow.id, categoryId: cinemaVip.id, price: new library_1.Decimal('1200') },
    });
